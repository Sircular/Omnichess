...
class Realizer 
{
	...
	Realize()
	{
		let outputArea = document.getElementById("boardDisplay");
	...
	DetermineForegroundColor(index, offsetColor)
	{
		...
		if (this.board.contents[index] !== undefined && this.board.contents[index].player !== undefined && this.board.contents[index].player.color !== undefined)
		{
